...
/*
gRPC TODO:
 1. Update a comment with information in request.(converse string to UUID)
...
gRPC TODO:
1. converse
2. Call dao API to delete a comment and do error handling. You need to handle comment not found error and other unknown error here.
